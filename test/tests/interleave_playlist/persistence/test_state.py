...
def test_create_state_file_when_file_not_exists_and_folder_not_exists(tmp_path):
...
def test_create_state_file_when_file_not_exists_and_folder_exists(tmp_path):
    state._STATE_FILE = tmp_path / 'state' / 'state.json'
...
def test_create_state_file_when_file_exists_and_folder_exists(tmp_path):
    state._STATE_FILE = tmp_path / 'state' / 'state.json'
    os.mkdir(state._STATE_FILE.parent)
